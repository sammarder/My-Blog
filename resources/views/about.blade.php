...
<html lang="en">
    ...
    <body>
        ...
        <p class="left-align">The home page uses vanilla JS with events being managed by the HTML side hence hitting tab before being able to interact with it. It is encouraged to try the wasd and arrow keys here to see how the page reacts. Also, if you provide /?name=[name] at the end of the home page, you can see that name as the title of the page.</p>
